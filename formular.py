...
def zeige_maske_ui(page: ft.Page, ansicht: ft.Column, nav_leiste, zeige_dashboard, zeige_fehler, markt_index):
    try:
        ...
        # --- HELFER: Textfeld (Schriftgröße 14, Padding 15 für bessere Treffbarkeit) ---
        ...
        # --- HELFER: Dropdown/Combo (Schriftgröße 14, große Pfeile & Puffer) ---
        ...
        # --- FIX: aktuelle_daten statt current_daten ---
        ...
        vl_dd = ft.Dropdown(options=[ft.dropdown.Option(k) for k in alle_vorlagen.keys()], hint_text="Vorlage wählen...", dense=True, content_padding=15, color="yellow", text_style=ft.TextStyle(color="yellow", size=14), border_color="white", icon_size=40)
        ...
        def lade_v(e):
            ...
            # Alle weiteren Sektionen befüllen (aus Platzgründen hier abgekürzt, Logik bleibt identisch)
        ...
        def hole_aktuelle_daten():
            ...
            d = {
                ...
                # ... Rest der Daten wie gewohnt ...
            }
            # (In der Vollversion hier alle weiteren Zuordnungen wieder einfügen)
            return d
        ...
        def save_final(e):
            ...
            if errs:
                ...
                fehler_text.visible = True; page.update(); return
            # PDF Erstellung Logik...
        ...
        def switch_tab(tab_id):
            ...
            # (Rest der Tabs identisch befüllen wie in deiner Vorlage)
            page.update()
