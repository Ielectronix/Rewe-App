...
def zeige_maske_ui(page: ft.Page, ansicht: ft.Column, nav_leiste, zeige_dashboard, zeige_fehler, markt_index):
    try:
        ...
        bottom_buttons = ft.ResponsiveRow([
            ft.Container(col={"xs": 12, "sm": 6}, content=ft.Row([action_btn_form("🚚 Touren", lambda e: zeige_dashboard(), "#F44336")]), padding=2),
            ft.Container(col={"xs": 12, "sm": 6}, content=ft.Row([action_btn_form("🔄 Zurücksetzen", reset_form, "#9C27B0")]), padding=2),
            ft.Container(col={"xs": 12, "sm": 6}, content=ft.Row([action_btn_form("💾 Speichern", nur_speichern, "#FF9800")]), padding=2),
            ft.Container(col={"xs": 12, "sm": 6}, content=ft.Row([action_btn_form("📄 Bericht", save_final, "#2196F3")]), padding=2),
