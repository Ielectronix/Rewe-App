...
def erstelle_bericht(d, assets_dir="assets"):
    ...
    if d.get("tw_kalt", False):
        f_map.update({
            "cb_0001_00": cb_val(True), "tf_0001_00_probenahmeUhrzeit": d.get("tw_zeit", ""), 
            ...
            "cb_0001_00_PE_ZS-002304_PN-Hahn": cb_val(d.get("tw_cb_pn")), "cb_0001_00_PE_ZS-002304_ Einhebel-Mischarmatur": cb_val(d.get("tw_cb_ein")), 
            "cb_0001_00_PE_ZS-002304_ Zweigriff-Mischarmatur": cb_val(d.get("tw_cb_zwei")), "cb_0001_00_PE_ZS-002304_ Eingriff-Armmatur": cb_val(d.get("tw_cb_ein_g")), 
            "cb_0001_00_PE_ZS-002304_ Sensor-Armatur": cb_val(d.get("tw_cb_sensor")), "cb_0001_00_PE_ZS-002304_ Eckventil": cb_val(d.get("tw_cb_eck")), 
            "cb_0001_00_PE_ZS-002304_ Armatur mit Kniebestätigung": cb_val(d.get("tw_cb_knie")), "cb_0001_00_PE_ZS-002304_Sonstiges": d.get("tw_zapf_sonst", ""), 
            ...
            "dd_0001_00_PE_ZS-002305_ Geruch": d.get("tw_kurz4", ""), "cb_0001_00_PE_ZS-1268_ja": cb_val(d.get("cb_auff_ja")), 
            "cb_0001_00_PE_ZS-1268_ nein": cb_val(d.get("cb_auff_nein")), "cb_0001_00_PE_ZS-1268_ Perlator nicht entfernbar": cb_val(d.get("cb_auff_perl")), 
            "cb_0001_00_PE_ZS-1268_ Starke Verkalkung": cb_val(d.get("cb_auff_verkalk")), "cb_0001_00_PE_ZS-1268_ Armatur mit Verbrühschutz": cb_val(d.get("cb_auff_verbrueh")), 
            "cb_0001_00_PE_ZS-1268_ Durchlauferhitzer": cb_val(d.get("cb_auff_durchlauf")), "cb_0001_00_PE_ZS-1268_ Unterbauspeicher": cb_val(d.get("cb_auff_unterbau")), 
            "cb_0001_00_PE_ZS-1268_ Eckventil warm/kalt geschlossen": cb_val(d.get("cb_auff_eck_zu")), "cb_0001_00_PE_ZS-1268_ nicht möglich": cb_val(d.get("cb_auff_nichtmoeglich")), 
            "cb_0001_00_PE_ZS-1268_ Entnahme aus der Dusche": cb_val(d.get("cb_auff_dusche")), "cb_0001_00_PE_ZS-1268_ Handbrause": cb_val(d.get("cb_auff_handbrause")), 
    ...
    if d.get("se_kalt", False):
        f_map.update({
            "cb_0002_00": cb_val(True), "tf_0002_00_probenahmeUhrzeit": d.get("se_zeit", ""), 
            "dd_0002_00_PE_ZS-002319": d.get("se_zapf", ""), "cb_0002_00_PE_ZS-002304_Eiswanne": cb_val(d.get("se_cb_eiswanne")), 
            "cb_0002_00_PE_ZS-002304_ Fallprobe": cb_val(d.get("se_cb_fallprobe")), "cb_0002_00_PE_ZS-002304_Sonstiges": d.get("se_tech_sonst", ""), 
            "dd_0002_00_PE_ZS-002255": d.get("se_desinf", ""), "cb_0002_00_PE_ZS-1268_Ozonsterilisator": cb_val(d.get("se_cb_ozon")), 
    ...
    if d.get("se_okz_cb", False):
        f_map.update({
            "cb_0003_00": cb_val(True), "tf_0003_00": "Abklatschproben Scherbeneis", "dd_0003_00_ZS-001796": d.get("se_okz_bemerkung", "")
        })
        for i in range(1, 4):
            idx = f"{i:02d}"
            f_map.update({
                f"dd_0003_{idx}_ZS-001880": d.get(f"se_okz_status_{idx}", ""), f"dd_0003_{idx}_ZS-1419": d.get(f"se_okz_objekt_{idx}", ""),
                f"dd_0003_{idx}_ZS-001792": d.get(f"se_okz_ort_{idx}", ""), f"cb_0003_{idx}_ZS-002294": cb_val(d.get(f"se_okz_abklatsch_{idx}")),
                f"cb_0003_{idx}_ZS-002295": cb_val(d.get(f"se_okz_tupfer_{idx}"))
            })

    if d.get("hfm_hack_cb", False):
        f_map.update({
            "cb_0004_00": cb_val(True), "tf_0004_00": "Hackfleisch gemischt", "dd_0004_00_ZS-001799": d.get("hfm_hack_entnahmeort", ""),
    ...
    if d.get("hfm_mett_cb", False):
        f_map.update({
            "cb_0006_00": cb_val(True), "tf_0006_00": "gewürztes Schweinemett", "dd_0006_00_ZS-001799": d.get("hfm_mett_entnahmeort", ""),
    ...
    if d.get("hfm_fzs_cb", False):
        ...
        f_map.update({
            "cb_0008_00": cb_val(True), "tf_0008_00": "Fleischzubereitung Schwein", "tf_0008_00_ Produkt \"Marinade\"": prod_mar_str_s,
    ...
    if d.get("hfm_fzg_cb", False):
        ...
        f_map.update({
            "cb_0007_00": cb_val(True), "tf_0007_00": "Fleischzubereitung Geflügel", "tf_0007_00_ Produkt \"Marinade\"": prod_mar_str_g, 
    ...
    if d.get("hfm_bio_cb", False):
        f_map.update({
            "cb_0005_00": cb_val(True), "tf_0005_00": "Biohackfleisch", "dd_0005_00_ZS-001799": d.get("hfm_bio_entnahmeort", ""),
    ...
    if d.get("hfm_okz_cb", False):
        f_map.update({
            "cb_0010_00": cb_val(True), "tf_0010_00": "Abklatschproben HFM", "dd_0010_00_ZS-001796": d.get("hfm_okz_bemerkung", "")
        })
        for i in range(1, 11):
            idx = f"{i:02d}"
            f_map.update({
                f"dd_0010_{idx}_ZS-001880": d.get(f"okz_status_{idx}", ""), f"dd_0010_{idx}_ZS-1419": d.get(f"okz_objekt_{idx}", ""),
                f"dd_0010_{idx}_ZS-001792": d.get(f"okz_ort_{idx}", ""), f"cb_0010_{idx}_ZS-002294": cb_val(d.get(f"okz_abklatsch_{idx}")),
                f"cb_0010_{idx}_ZS-002295": cb_val(d.get(f"okz_tupfer_{idx}"))
            })
            
    if d.get("og_cb", False):
        f_map.update({"cb_0009_00": cb_val(True), "tf_0009_00": "Obst-/Gemüse Convenience"})
        for i in range(1, 6):
            idx = f"{i:02d}"
            f_map.update({
    ...
    if d.get("og_okz_cb", False):
        f_map.update({
            "cb_0011_00": cb_val(True), "tf_0011_00": "Obst-Gemüse Abklatschproben", "dd_0011_00_ZS-001796": d.get("og_okz_bemerkung", ""), "Anmerkung": d.get("og_okz_anmerkung", "")
        })
        for i in range(1, 6):
            idx = f"{i:02d}"
            f_map.update({
                f"dd_0011_{idx}_ZS-001880": d.get(f"og_okz_status_{idx}", ""), f"dd_0011_{idx}_ZS-1419": d.get(f"og_okz_objekt_{idx}", ""),
                f"dd_0011_{idx}_ZS-001792": d.get(f"og_okz_ort_{idx}", ""), f"cb_0011_{idx}_ZS-002294": cb_val(d.get(f"og_okz_abklatsch_{idx}")),
                f"cb_0011_{idx}_ZS-002295": cb_val(d.get(f"og_okz_tupfer_{idx}"))
            })
