...
def main(page: ft.Page):
    ...
    try:
        ...
        # DER 100% SICHERE BUTTON (Kein content=, kein text=, einfach nur der String)
        ...
        def zeige_dashboard():
            ...
            if not maerkte:
                ...
                for index, markt in enumerate(maerkte):
                    ...
                    # KEIN ICONBUTTON MEHR: Wir nutzen den sicheren Button mit Emoji
                    btn_del = sicherer_button("🗑️", loesche_t, "red", "white", width=60, height=55)
                ...
                try:
                    ...
                    if p_list:
                        ...
                        for pdf in p_list:
                            ...
                            # KEIN ICONBUTTON MEHR: Wir nutzen den sicheren Button mit Emoji
                            btn_teilen = sicherer_button("📤 Senden", lambda e, d=pdf: system_teilen(d), "blue", "white", width=110, height=50)
                ...
                try:
                    ...
                    if p_list:
                        ...
                        for pdf in p_list:
                            ...
                            # KEIN ICONBUTTON MEHR: Wir nutzen den sicheren Button mit Emojis
                            btn_teilen = sicherer_button("📤 Senden", lambda e, fname=pdf: system_teilen(fname), "blue", "white", width=110, height=50)
                            btn_del = sicherer_button("🗑️", lambda e, pfad=pdf_komplett: [os.remove(pfad), zeige_postausgang()], "red", "white", width=60, height=50)
