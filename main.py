            ...
            try:
                ...
                def save_final(e):
                    ...
                    if tw_hat_daten and not tw_kalt_cb.value and not lims_override_cb.value:
                        switch_tab_tw(None); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI TRINKWASSER FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if se_hat_daten and not se_kalt_cb.value and not lims_override_cb.value:
                        switch_tab_se(None); switch_se_tab("eis"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI SCHERBENEIS FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if se_okz_hat_daten and not se_okz_cb.value and not lims_override_cb.value:
                        switch_tab_se(None); switch_se_tab("okz"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI SCHERBENEIS OKZ FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if hfm_hack_hat_daten and not hfm_hack_cb.value and not lims_override_cb.value:
                        switch_tab_hfm("hack"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI HACKFLEISCH GEMISCHT FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if hfm_mett_hat_daten and not hfm_mett_cb.value and not lims_override_cb.value:
                        switch_tab_hfm("mett"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI SCHWEINEMETT FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if hfm_fzs_hat_daten and not hfm_fzs_cb.value and not lims_override_cb.value:
                        switch_tab_hfm("schwein"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI FZ SCHWEIN FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if hfm_fzg_hat_daten and not hfm_fzg_cb.value and not lims_override_cb.value:
                        switch_tab_hfm("gefluegel"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI FZ GEFLÜGEL FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if hfm_bio_hat_daten and not hfm_bio_cb.value and not lims_override_cb.value:
                        switch_tab_hfm("bio"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI BIO-HACK FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
                    if og_hat_daten and not og_cb.value and not lims_override_cb.value:
                        switch_tab_og("teil"); fehler_text.value="⚠️ AKTIVIERUNGS-HAKEN BEI OG FEHLT!"; fehler_text.visible=True; status_text.value=""; page.update(); return
